    ...
    <div className="bg-[#131313] text-[#e5e2e1] min-h-screen">
      ...
      <main className="pt-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight headline-font leading-[1.05] text-white mb-8">
                Move your GTM to the <span className="text-[#ffb4a7]">Server</span> without a Developer.
              </h1>
              <p className="text-lg md:text-xl text-[#e6bdb6] max-w-xl leading-relaxed mb-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/dashboard" className="bg-[#ff553c] text-white px-8 py-4 rounded-xl font-bold text-lg hover:brightness-110 transition-all flex items-center justify-center gap-2">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative z-10 p-4 rounded-lg bg-[#20201f] border border-[#5d3f3a]/15 shadow-2xl">
                <div className="aspect-square rounded overflow-hidden bg-[#1c1b1b] flex items-center justify-center relative group">
                  <div className="absolute inset-0 bg-gradient-to-tr from-[#131313] to-[#ffb4a7]/10 opacity-50"></div>
              ...
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#ffb4a7]/10 rounded-full blur-[100px]"></div>
              <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-[#5fde8f]/5 rounded-full blur-[120px]"></div>
            </div>
          </div>
        </section>
        ...
        <section id="product" className="bg-[#1c1b1b] py-32 px-8 overflow-hidden">
          <div className="max-w-[1440px] mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="label-font text-sm uppercase tracking-widest text-[#e6bdb6]">Precision Engineering for your Data</p>
            </div>
            <div className="relative max-w-5xl mx-auto">
              <div className="bg-[#131313] border border-[#5d3f3a]/15 rounded-2xl p-2 shadow-2xl overflow-hidden">
                  ...
                  <div className="md:col-span-4 border-r border-[#5d3f3a]/10 p-6 space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between p-3 bg-[#2a2a2a] rounded-lg border border-[#ffb4a7]/20">
                          <div className="flex items-center gap-3">
                            <span className="material-symbols-outlined text-sm text-[#ffb4a7]">warning</span>
                            <span className="text-xs font-mono text-white">Custom JS Var</span>
                          </div>
                          <span className="text-[9px] label-font text-[#ffb4a7]">RESOLVING</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-8 p-8 flex flex-col justify-between bg-[#0e0e0e]">
                    ...
                    <div className="mt-12 flex flex-col items-center">
                      <div className="mb-8 text-center">
                        ...
                        <p className="text-sm text-[#e6bdb6]">We&apos;ve mapped your entire environment.</p>
                      </div>
                      <Link href="/dashboard" className="group relative bg-[#F63A22] text-white px-12 py-5 rounded-xl font-extrabold text-xl shadow-[0_0_40px_-10px_rgba(246,58,34,0.4)] hover:shadow-[0_0_60px_-10px_rgba(246,58,34,0.6)] transition-all flex items-center gap-4">
                        One-Click Convert
        ...
        <section id="features" className="py-32 max-w-[1440px] mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 rounded-2xl bg-[#20201f] hover:bg-[#2a2a2a] transition-colors group">
              <div className="w-14 h-14 rounded-xl bg-[#353535] flex items-center justify-center mb-8 border border-[#5d3f3a]/10 group-hover:border-[#ffb4a7]/30 transition-colors">
                <span className="material-symbols-outlined text-[#ffb4a7] text-3xl">analytics</span>
              </div>
              <h3 className="text-2xl font-bold headline-font mb-4 text-white">Automatic Readiness Report</h3>
              <p className="text-[#e6bdb6] leading-relaxed">Instantly identify which tags are compatible and which need adjustment before moving to the server.</p>
            </div>
            <div className="p-10 rounded-2xl bg-[#20201f] hover:bg-[#2a2a2a] transition-colors group">
              <div className="w-14 h-14 rounded-xl bg-[#353535] flex items-center justify-center mb-8 border border-[#5d3f3a]/10 group-hover:border-[#5fde8f]/30 transition-colors">
                <span className="material-symbols-outlined text-[#5fde8f] text-3xl">build</span>
              </div>
              <h3 className="text-2xl font-bold headline-font mb-4 text-white">Rule-Based Migration</h3>
              <p className="text-[#e6bdb6] leading-relaxed">30+ production rules automatically convert your tags with confidence scoring and validation.</p>
            </div>
            <div className="p-10 rounded-2xl bg-[#20201f] hover:bg-[#2a2a2a] transition-colors group">
              <div className="w-14 h-14 rounded-xl bg-[#353535] flex items-center justify-center mb-8 border border-[#5d3f3a]/10 group-hover:border-white/30 transition-colors">
                <span className="material-symbols-outlined text-white text-3xl">lock</span>
              </div>
              <h3 className="text-2xl font-bold headline-font mb-4 text-white">Privacy-First</h3>
              <p className="text-[#e6bdb6] leading-relaxed">GDPR/CCPA compliant with consent mode support. Own your first-party data infrastructure.</p>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="py-32 px-8 mb-20">
          <div className="max-w-5xl mx-auto rounded-[2rem] bg-gradient-to-br from-[#20201f] to-[#1c1b1b] border border-[#5d3f3a]/10 p-12 md:p-20 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(246,58,34,0.05),transparent)] pointer-events-none"></div>
            ...
            <p className="text-xl text-[#e6bdb6] mb-12 max-w-2xl mx-auto relative z-10">Production-ready serverless architecture. Deploy to AWS in 15 minutes.</p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
              <Link href="/auth/register" className="bg-white text-[#131313] px-12 py-5 rounded-xl font-bold text-xl hover:bg-[#ffdad4] transition-all active:scale-95">
                Get Started for Free
              </Link>
              <Link href="/dashboard" className="border border-[#ad8881] px-12 py-5 rounded-xl font-bold text-xl hover:bg-white/5 transition-all text-white active:scale-95">
                View Dashboard
              </Link>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 max-w-[1440px] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-3">
              <Link href="/dashboard" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">Dashboard</Link>
              <Link href="/migrations" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">Migrations</Link>
              <Link href="/imports" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">Imports</Link>
            </nav>
          </div>
          <div className="space-y-4">
            <h4 className="label-font text-xs font-bold uppercase tracking-widest text-white mb-6">Resources</h4>
            <nav className="flex flex-col gap-3">
              <a href="/docs" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">Documentation</a>
              <a href="https://github.com/YOUR_ORG/tag-relay" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">GitHub</a>
              <a href="/api" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">API</a>
            </nav>
          </div>
          <div className="space-y-4">
            <h4 className="label-font text-xs font-bold uppercase tracking-widest text-white mb-6">Legal</h4>
            <nav className="flex flex-col gap-3">
              <Link href="/privacy" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-white/40 text-sm hover:text-[#F63A22] transition-colors">
                Terms of Service
              </Link>
            </nav>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
            ...
            <div className="flex items-center gap-6 label-font text-xs">
              <Link href="/privacy" className="text-white/35 hover:text-[#F63A22] transition-colors">
                Privacy
              </Link>
              <Link href="/terms" className="text-white/35 hover:text-[#F63A22] transition-colors">
                Terms
              </Link>
            </div>
          </div>
